...
import img0 from '../../assets/templates/img0.png'
import img1 from '../../assets/templates/img1.png'
import img2 from '../../assets/templates/img2.png'
import img3 from '../../assets/templates/img3.png'
import img4 from '../../assets/templates/img4.png'
import img5 from '../../assets/templates/img5.png'
import img6 from '../../assets/templates/img6.png'
import img7 from '../../assets/templates/img7.png' 
import img8 from '../../assets/templates/img8.png'
import img9 from '../../assets/templates/img9.png'
import img10 from '../../assets/templates/img10.png'
import img11 from '../../assets/templates/img11.png'
//import img12 from '../../assets/templates/img2.png'
import img13 from '../../assets/templates/img13.png'
import img14 from '../../assets/templates/img14.png'
import img15 from '../../assets/templates/img15.png'
import img16 from '../../assets/templates/img16.png'
import img17 from '../../assets/templates/img17.png'
import img18 from '../../assets/templates/img18.png'
import img19 from '../../assets/templates/img19.png'
import img20 from '../../assets/templates/img20.png'
import img21 from '../../assets/templates/img21.png'
import img22 from '../../assets/templates/img22.png'
import img23 from '../../assets/templates/img23.png'
//import img24 from '../../assets/templates/img2.png'
import img25 from '../../assets/templates/img25.png'
import img26 from '../../assets/templates/img26.png'
import img27 from '../../assets/templates/img27.png'
import img28 from '../../assets/templates/img28.png'
import img29 from '../../assets/templates/img29.png'           
import img30 from '../../assets/templates/img30.png'
import img31 from '../../assets/templates/img31.png'
...
export const services = () => {
  ...
  return (
    <section id="services">
      <h5>Nos differentes categories de Menu</h5>
      <h2 id="entree">Entrées</h2>
        
        <div className="container portfolio_container">
        {
          data0.map(({id, image, title, prix, description}) =>{
            return (
        ...
        <h2 id="principaux">Plats principaux</h2>
        <div className="container portfolio_container">
        {
          data1.map(({id, image, title, prix, description}) =>{
            return (
              <article key={id} className="portfolio_item">
                <div className="portfolio_item_image">
                  <img src={image} alt={title}/>
        ...
        <div className="container portfolio_container">
        {
          data2.map(({id, image, title, prix, description}) =>{
            return (
              <article key={id} className="portfolio_item">
                <div className="portfolio_item_image">
                  <img src={image} alt={title}/>
        ...
        <h2 id="speciale">Plats spéciaux || occasions || événements particuliers</h2>
        
        <div className="container portfolio_container">
        {
          data3.map(({id, image, title, prix, description}) =>{
            return (
              <article key={id} className="portfolio_item">
                <div className="portfolio_item_image">
                  <img src={image} alt={title}/>
        ...
        <h2 id="vegetale">plats végétariens</h2>
        
        <div className="container portfolio_container">
        {
          data4.map(({id, image, title, prix, description}) =>{
            return (
              <article key={id} className="portfolio_item">
                <div className="portfolio_item_image">
                  <img src={image} alt={title}/>
        ...
        <div className="container portfolio_container">
        {
          data5.map(({id, image, title, prix, description}) =>{
            return (
              <article key={id} className="portfolio_item">
                <div className="portfolio_item_image">
                  <img src={image} alt={title}/>
